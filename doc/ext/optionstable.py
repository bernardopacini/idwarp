...
class OptionsTable(Table):
    ...
    def get_options(self, cls):
        ...
        class_instance = cls(raiseError=False)  # noqa
        cmd = f"self.defOpts = class_instance.{self.options['optionvar']}"
        exec(cmd)
    ...
    def run(self):
        ...
        # set the self.defOpts attribute
    ...
    def collect_rows(self):
        ...
        groups = []
        # options
        for key, value in self.defOpts.items():
            trow = nodes.row()
